...
def username():
    ...
    mbox.showinfo("PowerBrowser v6 Setup","Setup successful")
    window.destroy()
...
tk.CTkLabel(window, text="PowerBrowser v6 Setup", font=("Segoe UI", 20)).pack()
...
tk.CTkLabel(window, text="What do you want PowerBrowser v6 to call you?", font=("Segoe UI", 14)).pack()
